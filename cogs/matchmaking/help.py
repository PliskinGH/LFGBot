    ...
    async def send_help(self, interaction: discord.Interaction, topic: str):
        ...
        if (topic == constants.LFG_COMMAND):
            ...
            content = (
                ...
                "for this server.\n"
                "## Options\n"
                "`name`, `role`, `icon`, `color`, `channel`, `forum`, `tag`, "
                "`visibility`, `message`, `registration_api`, `match_api`, "
                "`match_url`, `website_url`, `registration_url`, `profile_url`, "
                "`max_players`.\n"
                "### command\n"
                ...
                "### channel\n"
                "The channel mention where the game's LFG posts are created; "
                "blank keeps them in the channel the command is used in.\n"
                "### forum\n"
